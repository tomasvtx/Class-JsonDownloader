...
/// <summary>
/// The <see cref="HttpClientHandler"/> class provides a simple interface for making asynchronous HTTP requests using <see cref="HttpClient"/>.
/// </summary>
/// <remarks>
...
/// </summary>
/// <remarks>
/// The class takes an instance of <see cref="HttpClientHandler"/> for handling HTTP requests. The <see cref="GetJsonAsync{JSON}"/> method
...
{
    /// <summary>
    /// Gets or sets the <see cref="HttpClientHandler"/> instance responsible for handling HTTP requests.
    /// </summary>
    ...
    /// </summary>
    /// <param name="httpClientHandler">The <see cref="HttpClientHandler"/> instance to be used for handling HTTP requests.</param>
    /// <remarks>
    /// This constructor receives an instance of <see cref="HttpClientHandler"/> to be used for making HTTP requests.
    /// </remarks>
    public JsonDownloader(HttpClientHandler httpClientHandler)
    {
        this.httpClientHandler = httpClientHandler;
    }

    /// <summary>
    /// Asynchronously retrieves JSON data from the specified URL using the configured <see cref="HttpClientHandler"/>.
    /// </summary>
    ...
    /// <remarks>
    /// This method initiates an asynchronous HTTP GET request using the configured <see cref="HttpClientHandler"/> and returns a tuple containing
